<%@ page contentType="text/html" pageEncoding="UTF-8" import="java.util.List, entidade.Professor" %>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
                ...
                <h2 class="text-center">Lista de Professores</h2>
                    ...
                    <div class="table-responsive-sm overflow-auto" style="max-height: 500px;">
                            ...
                            <tbody>
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td><%= prof.getCpf() %></td>
                                        <td>
                                                <a href="/aplicacaoMVC/admin/ProfController?acao=Alterar&id=<%=prof.getId()%>" class="btn btn-warning">Alterar</a>
                                                <a href="/aplicacaoMVC/admin/ProfController?acao=Excluir&id=<%=prof.getId()%>" class="btn btn-danger">Excluir</a>
                                        </td>
                                    </tr>
                                <%
                                    }
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <a href="/aplicacaoMVC/admin/ProfController?acao=Incluir" class="mb-2 btn btn-primary">Incluir</a>
                        </div>
                    <%
                        }
                    %>
