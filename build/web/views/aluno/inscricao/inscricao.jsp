    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-8 mt-5">
                <h3 class="text-center">Inscreva-se em uma disciplina</h3>
                ...
                <form action="/aplicacaoMVC/aluno/inscricao" method="POST">
                    <%
                    ...
                    %>
                        <div class="alert alert-info text-center mt-3" role="alert">
                            Não tem nenhuma disciplina para se inscrever.
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch d-flex justify-content-center">
                                                <input class="form-check-input custom-inscricao" type="checkbox" name="turmas" value="<%= turma.getProfessor().getId() %>-<%= turma.getDisciplina().getId() %>-<%= turma.getTurma().getCodigoTurma() %>" id="turma<%= turma.getTurma().getId() %>">
                                            </div>
                                        </td>
                                    </tr>
                                <%
